...
ActiveRecord::Schema.define(version: 20150819150416) do
  ...
  create_table "no_cms_blocks_page_constrained_views", id: false, force: :cascade do |t|
    t.integer "page_constrained_view_id", null: false
    t.integer "no_cms_block_id",          null: false
  end

  add_index "no_cms_blocks_page_constrained_views", ["no_cms_block_id", "page_constrained_view_id"], name: "index_blocks_page_constrained_views_on_block_id_and_view_id", unique: true
  add_index "no_cms_blocks_page_constrained_views", ["page_constrained_view_id", "no_cms_block_id"], name: "index_blocks_page_constrained_views_on_view_id_and_block_id"
